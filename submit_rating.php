...
$connect = new PDO("mysql:host=localhost;dbname=moviedb", "root", "");
...
if(isset($_POST["rating_data"]))
{
	...
	";
// SQL statement template is created and sent to the database.
...
// isset checks if the variable is declared or is set to NULL
